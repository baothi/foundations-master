...
RSpec.describe SelectionsController, type: :controller do
  ...
  describe 'GET #show' do
    it 'assigns the requested selection as @selection' do
      ...
      expect(assigns(:selection)).to eq(selection)
    end
  end
  ...
  describe 'GET #new' do
    it 'assigns a new selection as @selection' do
      ...
      expect(assigns(:selection)).to be_a_new(Selection)
    end
  end
  ...
  describe 'POST #create' do
    context 'with valid params' do
      ...
      it 'assigns a newly created selection as @selection' do
        post :create, { selection: valid_attributes }, valid_session
        expect(assigns(:selection)).to be_a(Selection)
        expect(assigns(:selection)).to be_persisted
      end

      it 'redirects to the created selection' do
        post :create, { selection: valid_attributes }, valid_session
        expect(response).to redirect_to(Selection.last)
      end
    end

    context 'with invalid params' do
      it 'assigns a newly created but unsaved selection as @selection' do
        post :create, { selection: invalid_attributes }, valid_session
        expect(assigns(:selection)).to be_a_new(Selection)
      end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested selection' do
        selection = Selection.create! valid_attributes
        put :update, { id: selection.to_param, selection: new_attributes }, valid_session
        selection.reload
      ...
      it 'redirects to the selection' do
        selection = Selection.create! valid_attributes
        put :update, { id: selection.to_param, selection: valid_attributes }, valid_session
        expect(response).to redirect_to(selection)
      end
    end
    ...
    context 'with invalid params' do
      it 'assigns the selection as @selection' do
        selection = Selection.create! valid_attributes
        put :update, { id: selection.to_param, selection: invalid_attributes }, valid_session
        expect(assigns(:selection)).to eq(selection)
      end
  ...
  describe 'DELETE #destroy' do
    ...
    it 'redirects to the selections list' do
      selection = Selection.create! valid_attributes
      delete :destroy, { id: selection.to_param }, valid_session
      expect(response).to redirect_to(selections_url)
    end
  end
