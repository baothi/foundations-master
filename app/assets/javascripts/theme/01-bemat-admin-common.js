...
;$(function(){
	...
	var AppSidebar = {
		...
		open: function(){
			$("#sidebar-toggle").data("state","open").removeClass("SidebarClose").addClass("SidebarOpen")
			...
			$("#right-content").addClass("SidebarOpen").removeClass("SidebarClose");

			AppSidebar.update();
		},
		close: function(){
			$("#sidebar-toggle").data("state","close").removeClass("SidebarOpen").addClass("SidebarClose");
		...
		toggle: function(){
			var st = $("#left-content").data("state");
			if (st == "closed") {
				AppSidebar.open();
			} else  if (st == "open") {
				AppSidebar.close();
	...
	window.Foundations.App 	= new App;
}(jQuery));
