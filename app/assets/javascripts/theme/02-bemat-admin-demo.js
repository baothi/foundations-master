...
var initstate = (function() {
	...
	$(function($) {
		$("#demoBematColor1").on("ifChecked",function(){
			Foundations.App.theme.lightHeaderBrand();
		});
		$("#demoBematColor2").on("ifChecked",function(){
			Foundations.App.theme.darkHeaderBrand();
		});
		$("#demoBematColor3").on("ifChecked",function(){
			Foundations.App.theme.lightHeaderToolbar();
		});
		$("#demoBematColor4").on("ifChecked",function(){
			Foundations.App.theme.darkHeaderToolbar();
		});
		$("#demoBematColor5").on("ifChecked",function(){
			Foundations.App.theme.lightSidebar();
		});
		$("#demoBematColor6").on("ifChecked",function(){
			Foundations.App.theme.darkSidebar();
		});
	 ...
	 */
	$(function($){
		var calendarElements = $("#bemat-calendar");
